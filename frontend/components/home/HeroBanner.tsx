...
import { Compass, Search, Calendar, Play, ArrowRight } from "lucide-react";
...
export default function HeroBanner() {
  ...
  return (
    <section className="relative min-h-[550px] flex items-start overflow-hidden pt-12 md:pt-14 pb-24 md:pb-28 border-b border-border">
      {/* Background Image (No color overlay/shade, original visible) */}
      ...
      {/* Decorative Rotating Compass (Subtle overlay) */}
      <div className="absolute top-1/2 -right-40 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-primary/5 flex items-center justify-center pointer-events-none z-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
        <div className="max-w-3xl flex flex-col gap-6 text-left">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-border w-max shadow-premium"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-navy-light max-w-lg lg:max-w-[480px] leading-relaxed font-light"
          >
          ...
          >
            <Link
              href="/book"
              className="px-8 py-4 rounded-xl bg-gold-gradient text-white font-semibold text-sm shadow-premium hover:shadow-premium-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center gap-2.5 group"
            >
            ...
            <Link
              href="/courses"
              className="px-8 py-4 rounded-xl border border-border bg-white text-navy font-semibold text-sm shadow-premium hover:shadow-premium-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center gap-2 group hover:border-primary/50 hover:bg-background-alt"
            >
